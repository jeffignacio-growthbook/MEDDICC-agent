...
def _make_filter_table_stub(rows, call_log):
    ...
    holding the fixture rows in deals_snapshot: only selected columns come back and
    ...
    return real_filter_table_on(with_data_dictionary({"deals_snapshot": rows}), call_log)
