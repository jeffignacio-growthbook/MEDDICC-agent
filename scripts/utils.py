...
def build_semantic_context(config: Optional[Dict] = None) -> str:
    ...
    if targets_path.exists():
        ...
        lines.append("  ✓ Conversion rate comes from metrics registry: 13.0% pooled (Q3-Q1 FY2026-27)")
        lines.append("  ✗ Segment rates pending verification - use pooled 13.0% for all segments")
        ...
        lines.append("  Example: At 13.0% pooled, $2.1M target needs $16.2M qualified pipeline")
