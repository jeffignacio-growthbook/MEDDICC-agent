...
def build_semantic_context(config: Optional[Dict] = None) -> str:
    ...
    if targets_path.exists():
        ...
        lines.append("  ✓ Conversion rate comes from metrics registry: 7.1% pooled (Q3-Q1 FY2026-27)")
        lines.append("  ✗ Segment rates pending verification - use pooled 7.1% for all segments")
        ...
        lines.append("  Example: At 7.1% pooled, $2.1M target needs $29.6M qualified pipeline")
